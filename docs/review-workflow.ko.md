---
title: 첫 변경 검토하기
description: 하나의 기능 변경을 의존성 선택부터 코드·테스트·화면 검토까지 따라갑니다.
---
...
프로젝트 공통 정의와 작업별 선택의 관계는 [의존성과 워크트리](dependencies.md)를 참고하세요. 프로젝트 **Tests**는 기본 체크아웃을 대상으로 합니다. 기능 작업의 근거는 해당 워크트리의 검토 화면과 실행 기록에서 확인해야 합니다.
